...
#
get_filename_component(filename "/Users/kevinho/Desktop/Lab10/build/gmp/src/gmp-6.2.1.tar.bz2" ABSOLUTE)
get_filename_component(directory "/Users/kevinho/Desktop/Lab10/build/gmp/src/gmp" ABSOLUTE)
...
#
set(i 1234)
while(EXISTS "${directory}/../ex-gmp${i}")
  math(EXPR i "${i} + 1")
endwhile()
set(ut_dir "${directory}/../ex-gmp${i}")
